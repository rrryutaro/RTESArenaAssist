...
_EDGE_LINE_COLORS = {
    "fence":  QColor(0x8a, 0x5a, 0x2b),
    "hedge":  QColor(0x2f, 0x7a, 0x3f),
    "garden": QColor(0x9d, 0xb8, 0x55),
}
_CROP_FILL_COLORS = {
    "corn": QColor(0xb5, 0xa1, 0x3a),
    "farm": QColor(0xc2, 0xa4, 0x5a),
}
_CROP_MARK_COLORS = {
    "corn": QColor(0x23, 0x4d, 0x12),
    "farm": QColor(0x5e, 0x3c, 0x18),
}

_CELL_COLORS_ARENA: dict[str, QColor] = {
    "wall":        QColor(130,  89,  48),
    "raised":      QColor( 97,  85,  60),
    "door":        QColor(146,   0,   0),
    "level_up":    QColor(  0, 105,   0),
    "level_down":  QColor(  0,   0, 255),
    "wet_chasm":   QColor(109, 138, 174),
    "dry_chasm":   QColor( 20,  40,  40),
    "lava_chasm":  QColor(255,   0,   0),
    "wild_wall":   QColor(109,  69,  32),
    "wild_door":   QColor(255,   0,   0),
    "wild_road":   QColor(199, 154,  90),
    "wild_corn":   QColor(0xb5, 0xa1, 0x3a),
    "wild_farm":   QColor(0xb5, 0xa1, 0x3a),
    "wild_field":  QColor(0xb5, 0xa1, 0x3a),
}
_WILD_FIELD_FLOOR_ID = 2

_CELL_COLORS_MAPVIEWER: dict[str, QColor] = {
    "wall":        QColor(130,  89,  48),
    "raised":      QColor(120, 120, 112),
    "door":        QColor(146,   0,   0),
    "hidden_door": QColor(168,  85, 212),
    "exit_door":   QColor(146,   0,   0),
    "level_up":    QColor(  0, 105,   0),
    "level_down":  QColor(  0,   0, 255),
    "wet_chasm":   QColor(109, 138, 174),
    "wall_chasm":  QColor( 92, 200, 190),
    "dry_chasm":   QColor( 20,  40,  40),
    "lava_chasm":  QColor(255,   0,   0),
    "wild_wall":   QColor(109,  69,  32),
    "wild_door":   QColor(255,   0,   0),
