...
def attach_read_aloud(widget: QWidget, get_text: Callable[[], str]) -> None:
...
def make_speaker_button(get_text: Callable[[], str], parent: Optional[QWidget]=None) -> QToolButton:
    ...
    return btn
__all__ = ['set_speaker', 'speaker_icon_enabled', 'attach_read_aloud', 'make_speaker_button']
