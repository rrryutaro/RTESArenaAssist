...
def build_ui(win: 'AssistWindow') -> None:
    ...
    win._save_tab_host = QWidget()
    _save_host_lay = QVBoxLayout(win._save_tab_host)
    _save_host_lay.setContentsMargins(0, 0, 0, 0)
    _save_host_lay.setSpacing(0)
    _save_host_lay.addWidget(win._tab_save)
    win._tabs.addTab(win._save_tab_host, i18n.tr('tab.save'))
