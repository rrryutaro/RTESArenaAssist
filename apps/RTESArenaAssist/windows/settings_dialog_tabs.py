...
def build_map_tab(dlg: '_SettingsDialog') -> QWidget:
    ...
    dlg._map_full_raised_wall_cb = QCheckBox()
    dlg._map_full_raised_wall_cb.setChecked(bool(settings.get('map_full_raised_as_wall', True)))
    dlg._map_full_raised_wall_cb.setToolTip(i18n.tr('settings.map_full_raised_as_wall_tip'))
    form.addRow(i18n.tr('settings.map_full_raised_as_wall') + ':', dlg._map_full_raised_wall_cb)
    dlg._map_raised_sight_spin = QSpinBox()
    dlg._map_raised_sight_spin.setRange(0, 100)
    dlg._map_raised_sight_spin.setSingleStep(5)
    dlg._map_raised_sight_spin.setSuffix(' %')
    dlg._map_raised_sight_spin.setValue(int(settings.get('map_raised_sight_threshold', 0)))
    dlg._map_raised_sight_spin.setToolTip(i18n.tr('settings.map_raised_sight_threshold_tip'))
    form.addRow(i18n.tr('settings.map_raised_sight_threshold') + ':', dlg._map_raised_sight_spin)
...
def _build_map_expression_group(dlg: '_SettingsDialog') -> QGroupBox:
    ...
    dlg._map_pipe_under_cb = QCheckBox(i18n.tr('settings.map_pipe_under_on'))
    dlg._map_pipe_under_cb.setChecked(bool(settings.get('map_pipe_under', True)))
    pipe_lay.addWidget(dlg._map_pipe_under_cb)
    pipe_lay.addSpacing(10)
    pipe_lay.addWidget(QLabel(i18n.tr('settings.map_pipe_opacity') + ':'))
    dlg._map_pipe_opacity_spin = QSpinBox()
    dlg._map_pipe_opacity_spin.setRange(10, 100)
    dlg._map_pipe_opacity_spin.setSingleStep(5)
    dlg._map_pipe_opacity_spin.setSuffix(' %')
    dlg._map_pipe_opacity_spin.setValue(int(settings.get('map_pipe_opacity', 100)))
    pipe_lay.addWidget(dlg._map_pipe_opacity_spin)
    pipe_lay.addStretch()
    dlg._map_pipe_under_cb.toggled.connect(dlg._map_pipe_opacity_spin.setEnabled)
    dlg._map_pipe_opacity_spin.setEnabled(dlg._map_pipe_under_cb.isChecked())
    form.addRow(i18n.tr('settings.map_pipe_under') + ':', pipe_row)
    pipe_note = QLabel(i18n.tr('settings.map_pipe_under_note'))
    pipe_note.setObjectName('dimLabel')
    pipe_note.setWordWrap(True)
    form.addRow(pipe_note)
