...
def detect_play_screen(analyzer, anchor: int, img_name: str, mif_name: str='', menu_active_was_zero: bool=False, area: str | None=None) -> Tuple[str, str]:
    ...
    if area == 'city':
        return detect_city_play_screen(analyzer, anchor, img_name, menu_active_was_zero=menu_active_was_zero)
    return detect_dungeon_play_screen(analyzer, anchor, img_name, menu_active_was_zero=menu_active_was_zero)
