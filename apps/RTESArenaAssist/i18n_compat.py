...
class V2Compat:
    ...
    def __init__(self, v2: i18n_v2.I18nV2, legacy_map: dict[str, int], default_locale: str='ja-JP'):
        self.v2 = v2
        self.legacy_map = legacy_map
        self.default_locale = default_locale

    @classmethod
    def load(cls, *, bundle_path: str, legacy_map_path: str, localpack_path: str | None=None, mods_dir: str | None=None, default_locale: str='ja-JP') -> 'V2Compat':
        v2 = i18n_v2.I18nV2.load(bundle_path=bundle_path, localpack_path=localpack_path, mods_dir=mods_dir)
