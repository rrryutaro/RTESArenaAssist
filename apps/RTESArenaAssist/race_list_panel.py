...
class _RaceRow(QFrame):
    ...
    def _apply_style(self) -> None:
        if self._disabled:
            self.setStyleSheet('QFrame#raceRow {  background: #1c2e3f;  border: 1px solid #2a3a48;  border-radius: 4px;}QFrame#raceRow QLabel {  color: #66707a;  background: transparent;  border: none;}')
        elif self._highlighted:
            self.setStyleSheet('QFrame#raceRow {  background: #2a4a6a;  border: 1px solid #5bc0de;  border-radius: 4px;}QFrame#raceRow QLabel {  color: #ffe680;  font-weight: bold;  background: transparent;  border: none;}')
        else:
            self.setStyleSheet('QFrame#raceRow {  background: #1c2e3f;  border: 1px solid #2a4258;  border-radius: 4px;}QFrame#raceRow:hover {  background: #233b52;  border-color: #5bc0de;}QFrame#raceRow QLabel {  background: transparent;  border: none;}QFrame#raceRow QLabel#raceRowProvinceEn,QFrame#raceRow QLabel#raceRowRaceEn {  color: #c9d1e0;}QFrame#raceRow QLabel#raceRowProvinceJa,QFrame#raceRow QLabel#raceRowRaceJa {  color: #a0c4d8;}')
...
def _parse_race_sections_simple(html_text: str) -> dict[str, str]:
    ...
    next_boundary_re = re.compile('<h[12][^>]*>', re.IGNORECASE)
    pos = 0
    while True:
...
def _parse_race_sections_full(html_text: str) -> dict[str, str]:
    ...
    next_boundary_re = re.compile('<h[123][^>]*>', re.IGNORECASE)
    pos = 0
    while True:
