...
def build_ui(tab: 'TabTranslate') -> None:
    ...
    spellbook_page = QWidget()
    spb_lay = QVBoxLayout(spellbook_page)
    spb_lay.setContentsMargins(0, 0, 0, 0)
    spb_lay.setSpacing(4)
    tab._spellbook_group = QGroupBox('')
    spbg_lay = QVBoxLayout(tab._spellbook_group)
    spbg_lay.setContentsMargins(4, 4, 4, 4)
    spbg_lay.setSpacing(2)
    tab._spellbook_header = QFrame()
    tab._spellbook_header.setObjectName('shopItemHeader')
    spbh_lay = QHBoxLayout(tab._spellbook_header)
    spbh_lay.setContentsMargins(8, 2, 8, 2)
    spbh_lay.setSpacing(8)
    tab._spellbook_header_mark = QLabel('')
    tab._spellbook_header_mark.setFixedWidth(16)
    tab._spellbook_header_en = QLabel(i18n.tr('spellbook.header_original'))
    tab._spellbook_header_ja = QLabel(i18n.tr('spellbook.header_translation'))
    for lbl, stretch in ((tab._spellbook_header_mark, 0), (tab._spellbook_header_en, 2), (tab._spellbook_header_ja, 2)):
        lbl.setAlignment(Qt.AlignmentFlag.AlignLeft | Qt.AlignmentFlag.AlignVCenter)
        lbl.setObjectName('shopItemHeaderLabel')
        spbh_lay.addWidget(lbl, stretch)
    tab._spellbook_header.setStyleSheet('QFrame#shopItemHeader {  background: #0e161e;  border: 1px solid #2a4258;  border-radius: 3px;}QFrame#shopItemHeader QLabel#shopItemHeaderLabel {  color: #7ab8d4;  background: transparent;  border: none;  font-size: 10px;  font-weight: bold;}')
    spbg_lay.addWidget(tab._spellbook_header)
    tab._spellbook_rows_widget = QWidget()
    tab._spellbook_rows_layout = QVBoxLayout(tab._spellbook_rows_widget)
    tab._spellbook_rows_layout.setContentsMargins(0, 0, 0, 0)
    tab._spellbook_rows_layout.setSpacing(2)
    tab._spellbook_rows_layout.addStretch(1)
    spellbook_scroll = QScrollArea()
    spellbook_scroll.setWidget(tab._spellbook_rows_widget)
    spellbook_scroll.setWidgetResizable(True)
    spellbook_scroll.setFrameShape(QScrollArea.Shape.NoFrame)
    spellbook_scroll.setHorizontalScrollBarPolicy(Qt.ScrollBarPolicy.ScrollBarAlwaysOff)
    spbg_lay.addWidget(spellbook_scroll, 1)
    spb_lay.addWidget(tab._spellbook_group, 1)
