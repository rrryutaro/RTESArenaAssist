...
from PySide6.QtWidgets import QAbstractItemView, QHBoxLayout, QHeaderView, QListWidget, QPushButton, QScrollArea, QSplitter, QTableWidget, QVBoxLayout, QWidget
...
def build_ui(tab: 'TabSave') -> None:
    ...
    tab._game_btns = [tab._btn_backup_all, tab._btn_backup_checked, tab._btn_backup_selected]
    ...
    tab._backup_btns = [tab._btn_restore_selected, tab._btn_restore_checked, tab._btn_restore_all, tab._btn_delete]
    ...
    tab._table.setHorizontalHeaderLabels(['', i18n.tr('save.col_slot'), i18n.tr('save.col_save_name'), i18n.tr('save.col_label'), i18n.tr('save.col_date')])
