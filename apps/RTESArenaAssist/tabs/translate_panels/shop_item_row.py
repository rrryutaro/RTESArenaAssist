...
class ShopItemRow(QFrame):
    ...
    def __init__(self, en: str, ja: str, price_display: str, extras: list[str] | None=None, parent=None, show_price: bool=True, unidentified: bool=False):
        ...
        self.setStyleSheet('QFrame#shopItemRow {  background: #1c2e3f;  border: 1px solid #2a4258;  border-radius: 4px;}QFrame#shopItemRow QLabel#shopItemRowEn {  color: #c9d1e0;  background: transparent;  border: none;}QFrame#shopItemRow QLabel#shopItemRowJa {  color: #a0c4d8;  background: transparent;  border: none;}QFrame#shopItemRow QLabel#shopItemRowMark {  color: #45babe;  background: transparent;  border: none;  font-weight: bold;}QFrame#shopItemRow QLabel#shopItemRowEnUnid {  color: #45babe;  background: transparent;  border: none;}QFrame#shopItemRow QLabel#shopItemRowJaUnid {  color: #45babe;  background: transparent;  border: none;}QFrame#shopItemRow QLabel#shopItemRowMeta {  color: #78a8ba;  background: transparent;  border: none;}QFrame#shopItemRow QLabel#shopItemRowPrice {  color: #f0c860;  background: transparent;  border: none;  font-weight: bold;}')
