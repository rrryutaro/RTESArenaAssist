...
def render_equipment_list(table: QTableWidget, items: list) -> None:
    ...
    for item_data in items:
        ...
        row = table.rowCount()
        table.insertRow(row)
        cells = [(mark, name_color, Qt.AlignmentFlag.AlignCenter | Qt.AlignmentFlag.AlignVCenter), ('?' if is_unidentified else '', _COL_CYAN if is_unidentified else _COL_DIM, Qt.AlignmentFlag.AlignCenter | Qt.AlignmentFlag.AlignVCenter), (slot_label, _COL_DIM, Qt.AlignmentFlag.AlignCenter | Qt.AlignmentFlag.AlignVCenter), (en, name_color, Qt.AlignmentFlag.AlignLeft | Qt.AlignmentFlag.AlignVCenter), (ja, name_color, Qt.AlignmentFlag.AlignLeft | Qt.AlignmentFlag.AlignVCenter), (weight, _COL_DIM, Qt.AlignmentFlag.AlignRight | Qt.AlignmentFlag.AlignVCenter), (condition, _COL_DIM, Qt.AlignmentFlag.AlignCenter | Qt.AlignmentFlag.AlignVCenter), (effect, _COL_DIM, Qt.AlignmentFlag.AlignLeft | Qt.AlignmentFlag.AlignVCenter)]
