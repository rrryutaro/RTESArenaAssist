...
FLAG_STATUS_POPUP_OFFSET    = 0x12BA
FLAG_EQUIPMENT_OPEN_OFFSET  = 0x129A
FLAG_SPELL_DETAIL_OFFSET    = 0x1AEA
SPELL_VIEW_OFFSET           = 0x8F6E
MENU_ACTIVE_OFFSET          = 0x127C
POPUP_OPEN_OFFSET           = 0x7924
CITY_NPC_ACTIVE_OFFSET      = 0xA845

ACTION_ACTIVE_OFFSET        = 0x79A9
