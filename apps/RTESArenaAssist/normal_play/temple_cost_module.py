...
_IMG_ALLOWED_SURFACE_KINDS = {'YESNO.IMG': frozenset({'tavern_cost_confirm', 'temple_donate_amount'}), 'NEWPOP.IMG': frozenset({'tavern_cost_show', 'temple_donate_amount'}), 'MENU_RT.IMG': frozenset({'tavern_cost_show', 'temple_donate_amount'})}
...
def poll_temple_cost(w, *, img_name: str) -> bool:
    ...
    try:
        from active_template_reader import read_active_template_candidates, read_current_text_pointer
