...
def poll_npc_dialog(w, *, b30, entry_handled: bool, npc_overlay_active: bool, in_interior: bool, npc_phase_raw, shop_buy_active: bool, shop_menu_visible: bool, facility_active_now: bool, npc_dialog: str, npc_dialog_changed: bool=True, c_area: str='', internalized_facility_active: bool=False, shop_state_kind: str='none', negot_handled: bool=False, active_tmpl_handled: bool=False) -> bool:
