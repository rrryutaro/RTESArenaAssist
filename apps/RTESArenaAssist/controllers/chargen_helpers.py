...
_CHARGEN_OPENING_HINT_ADDR = 276188176
_CHARGEN_OPENING_MAXLEN = 1024
_CHARGEN_OPENING_FULLREAD = 4096
_CHARGEN_OPENING_SCAN_START = 268435456
_CHARGEN_OPENING_SCAN_END = 301989888
_CHARGEN_OPENING_PREFIXES = ('Do not fear for it is I',)
_CHARGEN_OPENING_TEMPLATE_KEYS = frozenset({1400})
_CHARGEN_GOYENOW_HINT_ADDR = 275581232
_CHARGEN_GOYENOW_HINT_CHECKLEN = 32
_CHARGEN_GOYENOW_PREFIX = b'Go ye now in peace'
_CHARGEN_GOYENOW_SCAN_START = 274726912
_CHARGEN_GOYENOW_SCAN_END = 276824064
_GARBAGE_NPC_PATTERNS = (re.compile('^[A-Z]+\\.\\d+$'), re.compile('^[A-Z0-9_]+\\.[A-Z]+$'), re.compile('^[a-zA-Z][a-zA-Z0-9_@]{0,7}\\.[a-zA-Z0-9]{1,3}$'), re.compile('^\\S{1,20}\\.[a-zA-Z0-9]{1,3}$'), re.compile('^[+-]?\\d{1,3}$'))
